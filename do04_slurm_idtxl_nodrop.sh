...
# Name:			do04_slurm_mv_idtxl_nodrop.sh

# Author:		Kate Dembny
# Date:			3/17/23
# Updated:		6/21/23

# Syntax:		./do04_slurm_idtxl_nodrop.sh
# Arguments:	
...
# STEP 10: check for script completion - bivariate
...
# STEP 11: calculate script runtime based on number of nodes - bivariate
...
# STEP 12: make slurm script - bvte
...
# STEP 13: assign partition if 80 nodes
...
# STEP 14: add remaining default values to slurm script
...
# STEP 15: fix folder permissions and run individual slurm job - bvte
